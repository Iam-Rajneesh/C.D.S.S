  ...
  <nav class="navbar navbar-expand-lg navbar-dark bg-primary fixed-top">
    ...
    <div class="collapse navbar-collapse" id="navbarSupportedContent">
      ...
      <form class="form-inline my-2 my-lg-0" method="post" action="search.php">
        <input class="form-control mr-sm-2" type="text" placeholder="Enter contact number" aria-label="Search"
          name="contact">
...
<body style="padding-top:50px;">
    ...
    <div class="row">
      <div class="col-md-4" style="max-width:18%;margin-top: 3%;">
        <div class="list-group" id="list-tab" role="tablist">
          ...
          <a class="list-group-item list-group-item-action" href="#list-suggest" id="list-suggest-list" role="tab"
            data-toggle="list" aria-controls="home"> Health Bot</a>
      ...
      <div class="col-md-8" style="margin-top: 3%;">
        <div class="tab-content" id="nav-tabContent" style="width: 950px;">
                ...
                <div class="col-sm-4" style="left: 15%">
                  <div class="panel panel-white no-radius text-center">
                    <div class="panel-body">
                      <span class="fa-stack fa-2x"> <i class="fa fa-square fa-stack-2x text-primary"></i> <i
                          class="fa fa-list-ul fa-stack-1x fa-inverse"></i> </span>
                      <h4 class="StepTitle" style="margin-top: 5%;"> Health Bot</h4>

                      <p class="links cl-effect-1">
                        <a href="#list-suggest" onclick="clickDiv('#list-suggest-list')">
                          Health Bot
                        </a>
                      </p>
                    </div>
          ...
          <div class="tab-pane fade" id="list-suggest" role="tabpanel" aria-labelledby="list-home-list">


            <div class="Search-Section" style=" border:1px solid blue;width:100%;height:100%;">
              <div style="padding:20px">
                <h3 id="hbSearchQue" class="text-center" style="text-transform: capitalize;">
                  Disease Name will show here
                </h3>

                <div class="content-box">


                  <p id="hbSearchRes" class="bot-response"></p>




                  <!-- <span class="content_heading_demo2"> An array a man's will against his sickness is the supreme art of medicine." - Henry Ward Beecher.<br></span> -->
              ...
              <div class="search-box">
                <input type="text" placeholder="Search here..." id="hbSearchField">
                <center>
                  <button class="btn btn-primary mt-4" id="hbSearchBtn">Search</button>
                </center>
              </div>
            </div>
          ...
          <!-- <div class="container_search">
              <label for="fname">Ask Any Suggestion : </label>
              <input type="search" id="fname" class="textbox" name="fname">
  ...
  <script>
    const hbBtn = document.querySelector('#hbSearchBtn')
    const hbQuery = document.querySelector('#hbSearchField')
    const hbRes = document.querySelector('#hbSearchRes')
    const hbQue = document.querySelector('#hbSearchQue')

    hbBtn.addEventListener('click', () => {
      if (hbQuery.value == '') {
        alert("Can't leave the search field empty!")
        return
      }
      ...
      // handle
      hxr.onload = function () {
        hbQue.innerHTML = hbQuery.value;
        let data = this.responseText
        console.log(data);
        hbRes.innerHTML = data
      }

      // send
      hxr.open('GET', 'http://localhost/C.D.S.S/ml.php?query=' + hbQuery.value)
      hxr.send()
    })
  </script>
</body>
